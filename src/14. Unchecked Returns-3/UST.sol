...
abstract contract StandardToken is BasicToken, ERC20 {
     ...
     */
    function allowance(address _owner, address _spender) public virtual override returns (uint256) {
...
contract UST is Pausable, StandardToken, BlackList {
    ...
    // Forward ERC20 methods to upgraded contract if this one is deprecated
    function balanceOf(address who) public virtual override(BasicToken, ERC20Basic) returns (uint256) {
        if (deprecated) {
